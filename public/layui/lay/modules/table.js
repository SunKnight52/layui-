...
layui.define(['laytpl', 'laypage', 'layer', 'form'], function(exports){
            ...
            $.ajax({
                ...
                ,success: function(res){
                    if(res[response.statusName] != response.statusCode){
                        ...
                        {
                            that.renderForm();
                            that.layMain.html('<div class="'+ NONE +'">'+ (res[response.msgName] || res.message) +'</div>');
                            alertS(res.message)
                        }else{
                            that.renderForm();
    ...
    table.reload = function(id, options){
        ...
        var _config = $.extend(true, {}, config, options);
        _config.where = options.where;
        return table.render(_config);
